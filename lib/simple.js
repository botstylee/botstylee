const fs = require('fs')
   ...
   */
      ...
      */
      ...
      async sendButtonImg(jid, content, url, footer, button1, row1, options = {}) {
        const m = (await this.prepareMessageMedia(url, MessageType.image,{})).imageMessage
  ...
  exports.smsg = (conn, m, hasParent) => {
    ...
    if (m.message) {
      ...
      m.text = (m.mtype == 'listResponseMessage' ? m.msg.singleSelectReply.selectedRowId : '') || m.msg.text || m.msg.caption || m.msg.selectedButtonId || m.msg || ''
      /**
