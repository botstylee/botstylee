class TicTacToe {
	...
	static check(state) {
		for (var combo of [7, 56, 73, 84, 146, 273, 292, 448])
	...
	static render(boardX = 0, boardO = 0) {
		var x = parseInt(boardX.toString(2), 4)
		var y = parseInt(boardO.toString(2), 4) * 2
	...
	get winner() {
		var x = TicTacToe.check(this._x)
		var o = TicTacToe.check(this._o)
